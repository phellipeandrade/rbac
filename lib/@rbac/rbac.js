...
exports.regexFromOperation = exports.validators = exports.isRegex = exports.defaultLogger = exports.underline = exports.isFunction = exports.isPromise = void 0;
  ...
  return function (mappedRoles) {
    return function (role, operation, params) {
      return new Promise(function (resolve, reject) {
        ...
        if (regexOperation) {
          var result = Object.keys(foundedRole.can).some(function (operation) {
            return regexOperation.test(operation);
          });
