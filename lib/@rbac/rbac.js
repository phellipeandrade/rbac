  ...
  return function (mappedRoles) {
    return function (role, operation, params) {
      return new Promise(function (resolve, reject) {
        ...
        var resolveWhenPromise = function resolveWhenPromise(promise) {
        ...
        var resolveWhenFunction = function resolveWhenFunction(func) {
          return func(params, function (err, result) {
