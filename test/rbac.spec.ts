...
const belongsToAccount = (params: any, done: any) => done(null, params);

const PromisebelongsToAccount = new Promise<boolean>((resolve) => {
  resolve(true);
});

const asyncBelongsToAccount = async (params: any) => params;
...
describe('RBAC lib aspects', () => {
  ...
  it('should return an object with a property named [can] when rbac function is called', () => {
    const result = rbac()(defaultRoles);
